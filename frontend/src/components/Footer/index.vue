<template>
  <footer class="row text p-5 text-secondary p-footer">
    ...
    <div class="w-100">
      ...
      <!-- <div>33</div> -->
      <p class="w-100 text-center">This page was created by <a href="https://www.freecodecamp.com/aleks-askov"
           target="_blanket">Alexander Askov</a> &copy; {{year}}</p>
    </div>
