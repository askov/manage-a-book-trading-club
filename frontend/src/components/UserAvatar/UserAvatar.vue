<template>
  <div :class="avatarClassList" v-b-tooltip.hover :title="hoverTitle" @click="handleAvatarClick">
    <img v-if="avatar" :src="avatar" alt="user-avatar">
    <input v-if="editable" type="file" ref="file" style="display: none" @change="onImageChange">
  </div>
</template>
